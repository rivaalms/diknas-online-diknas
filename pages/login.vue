<template>
   <div id="container">
      <v-row dense>
                  ...
                  <v-card-text>
                     <v-form ref="form" @submit.prevent="onSubmit">
                        ...
                        <div class="d-flex justify-end">
                           <v-btn depressed type="submit" dark color="yellow darken-2" class="mt-5">Login</v-btn>
                        </div>
                     </v-form>
                  </v-card-text>
         ...
         <v-col cols="6" class="d-flex flex-column justify-center bg-light" align-self="stretch">
            <v-img
               contain
               src="/Spreadsheets-cuate.svg"
            ></v-img>
